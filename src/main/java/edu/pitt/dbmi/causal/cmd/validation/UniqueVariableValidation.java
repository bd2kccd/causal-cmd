...
/**
 *
 * Mar 14, 2017 1:45:16 AM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
public class UniqueVariableValidation implements TetradDataValidation {

    private static final Logger LOGGER = LoggerFactory.getLogger(UniqueVariableValidation.class);

    private final DataSet dataSet;
    private final Path outputFile;

    public UniqueVariableValidation(DataSet dataSet) {
        this(dataSet, null);
    }

    public UniqueVariableValidation(DataSet dataSet, Path outputFile) {
